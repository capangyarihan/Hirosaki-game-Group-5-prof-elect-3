...
#-------------------BULLET------------------------------------------------------------------
bulletImg = pygame.image.load('Hirosaki files/bullet2.png')
...
pauseImg = pygame.image.load("Hirosaki files/PAUSE1.png").convert_alpha()
playImg = pygame.image.load("Hirosaki files/RESUME3.png").convert_alpha()
playImg = pygame.transform.scale(playImg, (290, 100))
quitImg = pygame.image.load("Hirosaki files/QUITGAME.png").convert_alpha()
...
def open_main_file():
    subprocess.Popen([sys.executable, "HIROSAKI_GROUP5/MainMenu.py"])
    pygame.quit()
    sys.exit()
